...
# Configured with: './configure' '--prefix=/usr/local' '--target-list=arm-softmmu'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lutil -lncurses -ltinfo    -lpng12   -lgnutls   -lSDL   -lX11  -lz -L$(BUILD_DIR)/dtc/libfdt -lfdt -lspice-server   -lpixman-1  
ARCH=x86_64
...
VERSION=1.6.0
PKGVERSION=
SRC_PATH=/home/gabrielle/SAM3_codeqemu
...
QEMU_CFLAGS=-Werror -fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-all -I/usr/include/p11-kit-1   -I/usr/include/libpng12   -I/usr/include/spice-server -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/spice-1   -I/usr/include/pixman-1   -I$(SRC_PATH)/dtc/libfdt
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/gabrielle/SAM3_codeqemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
